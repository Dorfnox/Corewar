...
/*   Updated: 2018/06/20 01:13:16 by dmontoya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		xor_(t_corewar *core, t_process *process)
{
	...
	xor_result = a ^ b;
	REG[ARG20][0] = (uint8_t)(xor_result >> 24);
	REG[ARG20][1] = (uint8_t)(xor_result >> 16);
	REG[ARG20][2] = (uint8_t)(xor_result >> 8);
	REG[ARG20][3] = (uint8_t)(xor_result >> 0);
